...
# Home project: facegit 2/3
Я добавил совсем немного, в том числе работу с `localstorage`, что бы все время не вбивать ключ.
1. Написать тесты для всех существующих саг.
